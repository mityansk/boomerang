...
class Game {
  constructor({ trackLength }) {
    ...
    this.user = new Userok(this.username, `${this.username}@megagame.com`);
  ...
  regenerateTrack() {
    ...
    if (this.boomerang.state === 'returned') {
      this.view.gameOver(this.username);
    }
  }
